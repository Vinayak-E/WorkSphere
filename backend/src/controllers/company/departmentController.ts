...
export class DepartmentController {
  constructor( private readonly  departmentService: DepartmentService) {}
   ...
   getDepartments: RequestHandler = async ( req: Request, res: Response,next: NextFunction) => {
    try {
      ...
      const departments = await this.departmentService.getDepartments(tenantConnection);
    ...
    addDepartment: RequestHandler = async ( req: Request, res: Response,next: NextFunction) =>  {
      try {
        const tenantConnection = req.tenantConnection;
    ...
    updateDepartment: RequestHandler = async (req: Request, res: Response, next: NextFunction) => {
      try {
        const tenantConnection = req.tenantConnection;
