...
export class EmployeeService {
  ...
  async checkIn(
    ...
    try {
      ...
      const existingAttendance = await this.employeeRepository.findAttendance(
        connection,
        {
          employeeId,
          date: today,
      ...
      const isOnLeave = await this.employeeRepository.checkActiveLeave(
        connection,
        {
          employeeId,
          date: today,
      ...
      const attendance = await this.employeeRepository.createAttendance(
        connection,
        {
  ...
  async getAttendanceStatus(
    ...
    try {
      ...
      const attendance = await this.employeeRepository.findAttendance(
        connection,
        {
          employeeId,
          date: today,
