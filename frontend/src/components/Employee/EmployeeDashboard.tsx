...
export default function EmployeeDashboard() {
  ...
  const handleCheckInOut = async () => {
    ...
    try {
      ...
      const response = await api.post<AttendanceResponse>(endpoint, {
        employeeId,
      });
  ...
  return (
    <div className="p-4 md:p-8 max-w-7xl mx-auto bg-gray-50 dark:bg-gray-900 min-h-screen mt-4">
      ...
      >
        <Card
          className={`border-0 rounded-xl shadow-xl overflow-hidden transition-colors ${
            checkedIn
