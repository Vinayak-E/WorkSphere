        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 pt-12 pb-20">
            <div className="pt-10 lg:pt-20 flex flex-col justify-center">
              ...
              <div>
              <Link to="/register" className="bg-primary hover:bg-primary/90 hover:scale-105 text-primary-foreground px-8 py-3 rounded-full font-medium transition-all duration-200 shadow-lg hover:shadow-xl inline-block"> Get Started </Link>
              </div>
            </div>
