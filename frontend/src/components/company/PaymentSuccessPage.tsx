...
import { PaymentDetails } from '@/types/company/IPayment';
  ...
  useEffect(() => {
    const verifyPayment = async () => {
      try {
        ...
        const response = await CompanyService.verifyPayment(sessionId);
    ...
    <div className="bg-gray-100 min-h-screen flex flex-col justify-center items-center p-4">
      <div className="bg-white rounded-lg shadow-xl p-8 max-w-md w-full text-center">
        ...
        <p className="text-gray-600 mb-6">
          ...
          to all the features included in your selected plan.
        </p>
