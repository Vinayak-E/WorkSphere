...
export class ProfileController {
  ...
  static async handleProfileUpdate(formData: ProfileFormData,  employeeId: string ) {
    try {
      ...
      const updatedProfile = await ProfileService.updateProfile(formData, employeeId);
